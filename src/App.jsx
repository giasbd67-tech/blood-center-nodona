...
export default function App() {
  ...
  const downloadDonorCard = (donor) => {
    ...
    const drawPremiumCertificate = (logoImg, devImg) => {
      ...
      ctx.fillText(donor.name, 560, 475);

      // বর্ণনা লাইনসমূহ (ডোনারের জন্য পরিবর্তন করা হয়েছে)
      ...
      ctx.fillText(`রক্তের গ্রুপ: ${donor.bloodGroup}`, 560, 605);

      // ७. সিগনেচার এলাইনমেন্ট
    ...
    // আপনার প্রোজেক্টের আসল নাম অনুযায়ী ইমেজ লোড করা হচ্ছে
    Promise.all([
      loadImage('/logo.png'), // আপনার আসল লোগোর পাথ
      loadImage('/gias.png')      // আপনার আসল ছবির পাথ
    ]).then(([logoImg, devImg]) => {
